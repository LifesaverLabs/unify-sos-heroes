      ...
      <div className="container">
        <div className="mx-auto max-w-3xl text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            We advocate for universal implementation of both Good Samaritan immunity and Dutiful Suffragist duty-to-rescue laws worldwide.
          </p>
        </div>
          ...
          <Card className="border-2 border-emergency">
            <CardHeader>
              <div className="flex items-center gap-3 mb-2">
                ...
                <CardTitle className="text-2xl">Dutiful Suffragist Laws</CardTitle>
              </div>
              <CardDescription>Legal duty to assist and report</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                Dutiful Suffragist laws impose a legal duty to rescue or report emergencies, with civil or criminal penalties for failing to help when able to do so safely.
              </p>
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
        ...
        <Card className="bg-trust-light border-trust">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              We advocate for every country to adopt <strong>both</strong> Good Samaritan immunity and Dutiful Suffragist duty-to-rescue laws simultaneously. This dual approach:
            </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-muted-foreground mb-4">
                ...
                whose work on Dutiful Suffragist laws worldwide has documented the global landscape of duty-to-rescue legislation.
              </p>
